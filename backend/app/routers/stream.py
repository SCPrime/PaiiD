...
async def stream_positions(_: object = Depends(get_current_user), cache: CacheService = Depends(get_cache)):
    """
...
async def stream_market_indices(
    _: object = Depends(get_current_user), cache: CacheService = Depends(get_cache)
):
    """
...
async def stream_status(_: object = Depends(get_current_user)):
    """
