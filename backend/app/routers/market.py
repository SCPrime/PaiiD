...
@router.get("/market/conditions", dependencies=[Depends(get_current_user)])
...
@router.get("/market/indices", dependencies=[Depends(get_current_user)])
...
@router.get("/market/sectors", dependencies=[Depends(get_current_user)])
...
@router.get("/market/status", dependencies=[Depends(get_current_user)])
