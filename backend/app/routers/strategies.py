...
async def save_strategy(request: StrategyConfigRequest, _=Depends(require_current_user)):
    """
...
async def load_strategy(strategy_type: str, _=Depends(require_current_user)):
    """
...
async def list_strategies(_=Depends(require_current_user)):
    """
...
async def run_strategy(request: StrategyRunRequest, _=Depends(require_current_user)):
    """
...
async def delete_strategy(strategy_type: str, _=Depends(require_current_user)):
    """
...
async def get_strategy_templates(
    filter_by_risk: bool | None = True, _=Depends(require_current_user), db: Session = Depends(get_db)
):
    """
