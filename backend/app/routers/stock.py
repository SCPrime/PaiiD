...
@router.get("/{symbol}/info", dependencies=[Depends(get_current_user)])
...
@router.get("/{symbol}/news", dependencies=[Depends(get_current_user)])
...
@router.get("/{symbol}/complete", dependencies=[Depends(get_current_user)])
