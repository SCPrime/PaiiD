...
@router.get("/{symbol}/info", dependencies=[Depends(require_current_user)])
...
@router.get("/{symbol}/news", dependencies=[Depends(require_current_user)])
...
@router.get("/{symbol}/complete", dependencies=[Depends(require_current_user)])
