...
@router.get("/portfolio/summary", dependencies=[Depends(get_current_user)])
...
@router.get("/portfolio/history", dependencies=[Depends(get_current_user)])
...
@router.get("/analytics/performance", dependencies=[Depends(get_current_user)])
