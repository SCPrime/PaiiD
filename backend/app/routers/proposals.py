...
@router.post("/create", dependencies=[Depends(require_current_user)])
...
@router.post("/execute", dependencies=[Depends(require_current_user)])
...
@router.get("/history", dependencies=[Depends(require_current_user)])
