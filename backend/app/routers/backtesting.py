...
@router.post("/run", response_model=BacktestResponse, dependencies=[Depends(require_current_user)])
...
@router.get("/quick-test", dependencies=[Depends(require_current_user)])
