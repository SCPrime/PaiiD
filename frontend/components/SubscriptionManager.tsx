  ...
  const renderUsageBar = (usageData: UsageData) => {
    ...
    return (
      <div style={{ marginBottom: "20px" }}>
        ...
        >
          <span style={{ textTransform: "capitalize" }}>{usageData.feature.replace("_", " ")}</span>
  ...
  const renderTierCard = (tierId: string, tier: SubscriptionTier) => {
    ...
    return (
      <div
        key={tierId}
        style={{
          background: isCurrent ? "rgba(16, 185, 129, 0.1)" : "rgba(15, 23, 42, 0.6)",
          border: isCurrent
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", marginBottom: "16px" }}>
          ...
          <div>
            <h3 style={{ margin: 0, fontSize: "24px", color: "#fff" }}>{tier.name}</h3>
            <p style={{ margin: "4px 0 0 0", fontSize: "32px", fontWeight: 700, color }}>
              ${tier.price}
              <span style={{ fontSize: "16px", color: "#94a3b8", fontWeight: 400 }}>/month</span>
            </p>
          </div>
        </div>
    ...
    const features = [
      {
        ...
        value:
          limits.ml_predictions_per_month === -1
            ? "Unlimited"
            : `${limits.ml_predictions_per_month}/month`,
      },
      {
        label: "Backtests",
        value:
          limits.backtests_per_month === -1 ? "Unlimited" : `${limits.backtests_per_month}/month`,
      },
      {
        label: "Strategies",
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div style={{ marginBottom: "32px" }}>
        <h2 style={{ margin: "0 0 24px 0", fontSize: "28px", color: "#fff" }}>Available Plans</h2>
