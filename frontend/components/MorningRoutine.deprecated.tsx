        ...
        <GlassCard>
          ...
          >
            {[
              ...
              {
                label: "Day Change",
                value: `${portfolio.dayChange >= 0 ? "+" : ""}$${Math.abs(portfolio.dayChange).toFixed(2)}`,
                color: portfolio.dayChange >= 0 ? theme.colors.primary : theme.colors.danger,
              },
              {
                label: "Day Change %",
                value: `${portfolio.dayChangePercent >= 0 ? "+" : ""}${portfolio.dayChangePercent.toFixed(2)}%`,
                color: portfolio.dayChangePercent >= 0 ? theme.colors.primary : theme.colors.danger,
              },
              {
                label: "Buying Power",
                value: `$${portfolio.buyingPower.toLocaleString("en-US", { minimumFractionDigits: 2 })}`,
                color: accentColor,
              },
            ].map((item, idx) => (
              <div
              ...
              >
                <div
                  style={{ fontSize: "12px", color: theme.colors.textMuted, marginBottom: "4px" }}
                >
                  {item.label}
                </div>
            ...
            {systemChecks.map((check, index) => (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: theme.spacing.md }}>
                  ...
                  {check.status === "fail" && (
                    <XCircle
                      style={{ width: "20px", height: "20px", color: theme.colors.danger }}
                    />
                  )}
