...
export default function RiskCalculator({ onCreateProposal, onExecuteProposal }: RiskCalculatorProps) {
    ...
    <div style={{
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        <button
          ...
          style={{
            width: '100%',
            padding: '10px',
            background: loading ? 'rgba(100, 116, 139, 0.5)' : 'linear-gradient(135deg, #1a7560 0%, #0d5a4a 100%)',
            color: '#fff',
            border: 'none',
            borderRadius: '6px',
            fontSize: '14px',
      ...
      {proposal && (
        <div style={{
          ...
          {/* Risk Metrics */}
          <div style={{ marginBottom: '16px' }}>
            <h4 style={{ color: '#cbd5e1', fontSize: '14px', marginBottom: '8px' }}>Risk Analysis</h4>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
              <div>
              ...
              <div>
                ...
                <div style={{ color: '#10b981', fontWeight: '600' }}>
                  {proposal.max_profit === 999999 ? 'Unlimited' : `$${proposal.max_profit.toFixed(2)}`}
                </div>
              </div>
              <div>
          ...
          {/* Execution Section */}
          <div>
            <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '4px', fontSize: '14px' }}>
              Limit Price
            </label>
            <input
              type="number"
