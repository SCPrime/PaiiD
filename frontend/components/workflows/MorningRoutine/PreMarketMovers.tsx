      ...
      >
        <button
          ...
          style={{
            ...
            background: viewMode === "gainers" ? `${paidTheme.colors.success}20` : "transparent",
            border:
              viewMode === "gainers"
                ? `1px solid ${paidTheme.colors.success}60`
                : "1px solid transparent",
            borderRadius: paidTheme.borderRadius.sm,
            color: viewMode === "gainers" ? paidTheme.colors.success : paidTheme.colors.textMuted,
        ...
        <button
          ...
          style={{
            flex: 1,
            padding: paidTheme.spacing.sm,
            background: viewMode === "losers" ? `${paidTheme.colors.error}20` : "transparent",
            border:
              viewMode === "losers"
                ? `1px solid ${paidTheme.colors.error}60`
                : "1px solid transparent",
            borderRadius: paidTheme.borderRadius.sm,
            color: viewMode === "losers" ? paidTheme.colors.error : paidTheme.colors.textMuted,
            fontSize: paidTheme.typography.fontSize.sm,
            fontWeight: 600,
            cursor: "pointer",
            transition: `all ${paidTheme.animation.duration.normal}`,
              ...
              <div style={{ display: "flex", alignItems: "center", gap: paidTheme.spacing.md }}>
                <div
                  style={{
                    ...
                    border: `1px solid ${
                      isGainers ? paidTheme.colors.success : paidTheme.colors.error
                    }40`,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontSize: paidTheme.typography.fontSize.xs,
                    color: isGainers ? paidTheme.colors.success : paidTheme.colors.error,
                    fontWeight: 600,
