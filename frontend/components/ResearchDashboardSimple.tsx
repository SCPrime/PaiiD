    ...
    <div style={{ padding: theme.spacing.lg }}>
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <div
                style={{
                  ...
                  fontWeight: "700",
                  color:
                    priceChange && priceChange >= 0 ? theme.colors.primary : theme.colors.danger,
                }}
              >
                {priceChange !== null
        ...
        !error && (
          <Card style={{ marginTop: theme.spacing.lg }}>
            ...
            >
              ...
              <div style={{ fontSize: "16px" }}>Enter a ticker symbol to start researching</div>
            </div>
          </Card>
        )
      )}
      ...
      {hasData && (
        <Card glow="teal" style={{ marginTop: theme.spacing.lg }}>
          ...
          <div
            style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: theme.spacing.md }}
          >
            {[
              "SMA 20",
              "SMA 50",
      ...
      {hasData && (
        <div style={{ marginTop: theme.spacing.lg }}>
          <Button variant="secondary">Show Options Chain</Button>
        </div>
      )}
    </div>
  );
