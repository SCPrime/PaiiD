...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md px-4 py-2",
      "bg-slate-700/80 text-slate-200 font-semibold border border-slate-600",
      "hover:bg-slate-600/80 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2",
      "transition-all duration-150",
      className
    )}
    {...props}
