          ...
          {filteredTrades.length === 0 ? (
            <div className="text-center py-12 bg-slate-800/50 rounded-xl border border-slate-700">
              ...
              <p className="text-sm text-slate-500 mt-1">
                All automated trades have been processed
              </p>
            </div>
          ) : (
            filteredTrades.map((trade) => (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div
                      className={`p-3 rounded-lg ${trade.trade_type === "buy" ? "bg-green-500/20" : "bg-red-500/20"}`}
                    >
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`px-2 py-1 text-xs font-medium rounded-full ${getRiskColor(trade.risk_score)}`}
                        >
                          ...
                          <div className="flex-1 bg-slate-700 rounded-full h-2">
                            <div
                              className={`h-2 rounded-full ${
                                trade.supporting_data.news_sentiment > 0
                                  ? "bg-green-400"
                                  : "bg-red-400"
                              }`}
                              style={{
