...
const WatchlistPanel: React.FC<WatchlistPanelProps> = ({
  ...
  useEffect(() => {
    ...
    const handleProfileUpdate = (event: CustomEvent) => {
      ...
      if (
        selectedWatchlistId &&
        !updatedProfile.watchlists.find((w: Watchlist) => w.id === selectedWatchlistId)
      ) {
              ...
              {profile.watchlists.map((watchlist) => (
                <button
                  ...
                  style={{
                    ...
                    background:
                      selectedWatchlistId === watchlist.id ? theme.primary : theme.bgLight,
            ...
            >
              {selectedWatchlist ? (
                <>
                  ...
                  <p style={{ margin: 0, fontSize: "16px" }}>No symbols in this watchlist</p>
