      ...
      fields: [
        {
          ...
          type: "input",
          tooltip:
            "This is how you'll be identified in the platform. Choose a name you're comfortable with.",
          icon: User,
        },
        {
          name: "email",
          ...
          type: "input",
          tooltip:
            "We'll use this to send you important updates and notifications. Your email is kept private.",
          icon: Mail,
        },
        {
          name: "testGroup",
          ...
          tooltip:
            "Select your tester group if you were assigned one. This helps us organize feedback.",
          icon: Users,
        },
      ],
    },
      ...
      fields: [
        {
          ...
          tooltip:
            "This helps us recommend appropriate strategies and risk levels aligned with your objectives.",
          icon: Target,
        },
        {
          ...
          tooltip:
            "Your time horizon affects strategy selection - longer horizons typically allow for more growth-oriented approaches.",
          icon: TrendingUp,
        },
      ],
    },
      ...
      fields: [
        {
          ...
          tooltip:
            "This determines position sizing recommendations and helps us calibrate portfolio metrics. Your information is encrypted and private.",
          icon: DollarSign,
        },
        {
          name: "currentAssets",
          ...
          tooltip:
            "Understanding your existing holdings helps us avoid over-concentration and suggest complementary strategies.",
          icon: BookOpen,
        },
      ],
    },
      ...
      fields: [
        {
          ...
          tooltip:
            "This sets default stop-loss levels, position sizes, and strategy recommendations. You can adjust individual trades later.",
          icon: TrendingUp,
        },
        {
          ...
          tooltip:
            "We'll customize the interface complexity and provide educational resources matched to your experience level.",
          icon: BookOpen,
        },
        {
          ...
          tooltip:
            "Your initial strategy selection configures default screens, alerts, and workflow priorities. You can create multiple strategies later.",
          icon: Target,
        },
      ],
    },
      ...
      fields: [
        {
          ...
          tooltip:
            "Select all asset types you want to trade. This configures available research tools and screening options.",
        },
        {
          ...
          tooltip:
            "Sets the minimum amount for each individual position. Helps with diversification and position sizing.",
        },
        {
          ...
          tooltip:
            "Sets the maximum amount for each position. Prevents over-concentration in single positions.",
        },
        {
          name: "amountToInvest",
          ...
          tooltip:
            "How much of your available capital to deploy initially. Remaining capital stays as buying power for opportunities.",
        },
      ],
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          tooltip:
            "Manual: Confirm every trade. Auto Small: Trades under $1K execute automatically. Auto All: All trades execute per strategy (you can always override).",
        },
      ],
    },
    {
        ...
        <div style={{ width: "100%", maxWidth: "900px", margin: "auto" }}>
          ...
          <GlassCard glow="teal">
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
              <h1
                style={{ color: theme.colors.text, fontSize: "28px", fontWeight: 700, margin: 0 }}
              >
                {page.title}
              </h1>
              <div
              ...
              >
                ...
                {showTooltip === "workflow" && (
                  ...
                  >
                    Your morning routine is the workflow you&apos;ll follow each trading day. Select
                    steps in the order you want to complete them. This helps establish consistent
                    habits and ensures you don&apos;t miss critical steps.
                  </div>
                )}
              </div>
            </div>
                  ...
                  {availableWedges.map((wedge) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isAdded && (
                          <CheckCircle size={18} style={{ color: theme.colors.primary }} />
                        )}
                      </button>
                    );
                  })}
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                    {userData.morningRoutineWorkflow.map((wedgeId, idx) => {
                      ...
                      return (
                        ...
                        >
                          <span
                            style={{ color: theme.colors.primary, fontWeight: 700, width: "24px" }}
                          >
                            {idx + 1}.
                          </span>
                          <Icon size={20} style={{ color: wedge.color }} />
                          <span style={{ flex: 1, color: theme.colors.text, fontSize: "14px" }}>
                            {wedge.label}
                          </span>
                          <div style={{ display: "flex", gap: "4px" }}>
                            ...
                            >
                              <ChevronLeft
                                size={16}
                                style={{ color: theme.colors.text, transform: "rotate(90deg)" }}
                              />
                            </button>
                            <button
                              ...
                              style={{
                                ...
                                border: "none",
                                cursor:
                                  idx === userData.morningRoutineWorkflow.length - 1
                                    ? "not-allowed"
                                    : "pointer",
                                opacity:
                                  idx === userData.morningRoutineWorkflow.length - 1 ? 0.3 : 1,
                              }}
                            >
                              <ChevronRight
                                size={16}
          ...
          <GlassCard glow="teal">
                ...
                >
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between" }}>
                    ...
                    <span style={{ color: theme.colors.text }}>
                      {userData.investmentRangeMin} - {userData.investmentRangeMax}
                    </span>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <p style={{ color: theme.colors.textMuted, fontSize: "11px", marginBottom: "12px" }}>
                Based on your {userData.riskTolerance} risk tolerance and{" "}
                {userData.preferredStrategy} strategy:
              </p>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "12px" }}>
                ...
                >
                  <p
                    style={{ color: theme.colors.textMuted, fontSize: "10px", marginBottom: "4px" }}
                  >
                    Daily Avg
                  </p>
                  <p
              ...
              >
                * Estimates based on historical performance. Past performance does not guarantee
                future results.
              </p>
            </div>
