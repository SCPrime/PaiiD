...
const fixes = {
  ...
  "components/StrategyBuilder.deprecated.tsx": [
    ...
    {
      from: 'Design your own "custom" strategies',
      to: "Design your own &quot;custom&quot; strategies",
    },
  ],
  ...
  "components/TemplateCustomizationModal.tsx": [
    {
      from: "import { GlassCard, GlassButton, GlassInput, theme }",
      to: "import { GlassButton, theme }",
    },
  ...
  "components/trading/PLSummaryDashboard.tsx": [
    {
      from: "function DashboardCard({ title, children, period }: {",
      to: "function DashboardCard({ title, children, period: _period }: {",
    },
  ],
  ...
  "components/trading/StrategyBuilder.tsx": [
    {
      from: "import type { Strategy, ValidationResult, ValidationError, ValidationWarning }",
      to: "import type { Strategy, ValidationResult }",
    },
  ],
  ...
  "strategies/validator.ts": [
    ...
    {
      from: "function validateUniverse(u: any, errors: ValidationError[], warnings: ValidationWarning[])",
      to: "function validateUniverse(u: any, errors: ValidationError[], _warnings: ValidationWarning[])",
    },
    {
      from: "function validateEntry(e: any, errors: ValidationError[], warnings: ValidationWarning[])",
      to: "function validateEntry(e: any, errors: ValidationError[], _warnings: ValidationWarning[])",
    },
    {
      from: "function validateExits(e: any, errors: ValidationError[], warnings: ValidationWarning[])",
      to: "function validateExits(e: any, errors: ValidationError[], _warnings: ValidationWarning[])",
    },
    {
      from: "function validateRisk(r: any, errors: ValidationError[], warnings: ValidationWarning[])",
      to: "function validateRisk(r: any, errors: ValidationError[], _warnings: ValidationWarning[])",
    },
    {
      from: "function validateAutomation(a: any, errors: ValidationError[], warnings: ValidationWarning[])",
      to: "function validateAutomation(a: any, errors: ValidationError[], _warnings: ValidationWarning[])",
    },
  ],
};
