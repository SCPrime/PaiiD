  ...
  return (
    ...
    >
      ...
      <div style={{ width: "100%", maxWidth: "600px", margin: "0 auto" }}>
        <RadialMenu onWorkflowSelect={setSelected} onWorkflowHover={setHovered} />
      </div>
      ...
      {displayWorkflow && (
        ...
        >
          ...
          <p style={{ color: "#cbd5e1", lineHeight: 1.5 }}>{displayWorkflow.description}</p>
          {selected === displayWorkflow.id && (
            <p
              style={{
                marginTop: "12px",
      ...
      {!displayWorkflow && (
        ...
        >
          ...
          <p style={{ color: "#cbd5e1", lineHeight: 1.5 }}>
            Select a workflow stage from the radial menu above to begin. Each segment represents a
            key phase in your trading routine, from morning market analysis to strategy execution.
          </p>
        </div>
      )}
